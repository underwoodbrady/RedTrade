...
<button
	class={dropDownOpen ? "relative rounded-tr-md rounded-tl-md rounded-br-none rounded-bl-none w-44 py-2 px-4 bg-neutral-700 flex space-x-4 items-center justify-between" :"relative rounded-full w-44 py-2 px-4 bg-[#303030] flex space-x-4 items-center justify-between drop-shadow-sm hover:bg-neutral-700"}
	on:click={() => {
...
>
	...
	{#if dropDownOpen}
		<div class="absolute top-full -left-4 bg-neutral-700 w-full py-2 px-2 rounded-tr-none rounded-tl-none rounded-br-md rounded-bl-md drop-shadow-sm">
