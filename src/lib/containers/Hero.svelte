<section class="relative min-h-screen bg-[#292929] px-24">
	<div class="absolute left-0 right-0 top-0 bottom-0 backgroundimg opacity-20" />
	<div class="relative w-full h-screen flex items-center justify-between max-w-7xl mx-auto">
		<div class="w-1/2 max-w-2xl space-y-12">
			...
			<button class="px-4 py-2 text-nuetral-800 bg-brand font-semibold rounded-md text-xl"
