<section
	class="relative min-h-screen bg-[#2d2d2d] px-20 py-24 flex flex-col justify-center items-center"
>
	...
	<div class="relative w-full flex items-center justify-between max-w-6xl mx-auto mb-20">
		<div class="w-1/2 max-w-2xl space-y-12">
			<h3 class="text-white font-bold text-6xl">
				The Easiest, Fastest, and Most Intuitive <span class="text-brand"
					>Trading Platform Ever</span
				>
			</h3>
			<button
				class="px-4 py-2 text-neutral-800 bg-brand font-semibold rounded-md text-xl drop-shadow-md"
				on:click={() => window.location.assign(`http://${window.location.host}/signup`)}
