<section class="relative min-h-screen bg-[#2d2d2d] px-24">
	<div class="absolute left-0 right-0 top-0 bottom-0 backgroundimg opacity-[0.1]" >
		<div class="backgroundgrad w-full h-full"/>
	</div>
	<div class="relative w-full h-screen flex items-center justify-between max-w-7xl mx-auto">
		<div class="w-1/2 max-w-2xl space-y-12">
			...
			<button class="px-4 py-2 text-nuetral-800 bg-brand font-semibold rounded-md text-xl drop-shadow-md"
...
<style>
	...
	.glow {
		box-shadow: 0px 0px 35px 8px rgba(235, 61, 61, 0.4);
	}
	.backgroundgrad {
