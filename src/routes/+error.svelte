...
<main class="relative bg-[#2d2d2d] w-full min-h-screen">
	<div class="absolute left-0 right-0 top-0 bottom-0 backgroundimg opacity-[0.1]">
		<div class="backgroundgrad w-full h-full" />
	</div>
	<div class="relative w-full min-h-screen z-40 flex flex-col items-center justify-center">
		<h1 class="font-bold text-white text-5xl mb-5">Whoops...</h1>
		<p class="font-semibold text-neutral-200 text-lg mb-8">
			An Error Occured When Navigating To <span class="text-neutral-300 font-normal"
